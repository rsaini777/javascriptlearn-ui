    ...
    <div className="mx-auto max-w-md px-6 pt-28 pb-16">
      <div className="glass-card p-6">
        ...
        <form className="space-y-4">
          <div>
            <label className="block text-white/90 text-sm">Name</label>
            <input className="mt-1 w-full px-3 py-2 rounded-md bg-white/80 outline-none" style={{ color: '#00171f' }} type="text" placeholder="Your name" />
          </div>
          <div>
          ...
          <button className="glass-button px-4 py-2 font-semibold w-full" style={{ color: '#00171f', backgroundColor: '#ffffffcc' }} type="submit">Create account</button>
        </form>
      </div>
    </div>
  );
